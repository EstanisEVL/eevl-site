const FooterSocials = () => {
  return(
    <div className='footer-socials'>
      <ul>
        <li>
          <a href="https://github.com/EstanisEVL" aria-label='GitHub' rel="noopener noreferrer" target='_blank'>
        ...
        <li>
          <a href="https://www.linkedin.com/in/estanislao-elias-varela-lucius-developer/" aria-label='Linkedin' rel="noopener noreferrer" target='_blank'>
